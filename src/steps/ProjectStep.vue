<template>
  <div class="has-text-centered mt-6 py-6 project-screen" 
    data-aos="fade-up" id="stepsRef3">
            ...
            <div class="carousel__item-content">
              <figure class="image carousel__item-picture" >
                <img
                  ...
                  :alt="$t(`projects.image_alt_${index}`)" data-aos="zoom-in"
                />
              </figure>

              <h2 class="has-text-weight-bold is-size-4-mobile is-size-2 mb-6" data-aos="fade-left">
                ...
                <div class="is-flex is-flex-wrap-wrap mb-3">
                  ...
                  >
                    <span class="icon" v-if="$te(`projects.techs_${index}.tech_${project}`)">
                      <ion-icon data-aos="fade-right"
                        :name="'logo-' + $t(`projects.techs_${index}.tech_${project}`)"
                      ></ion-icon>
                    </span>
                    <span class="icon" v-else>
                      <ion-icon name="logo-web-component" data-aos="fade-right"></ion-icon>
                    </span>
